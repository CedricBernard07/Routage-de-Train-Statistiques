...
// Base d'URL pour le backend exposé par Docker (voir docker-compose.yml).
const API_BASE = 'http://localhost:8080/api/v1';

// Envoie une requête de création de trajet au backend.
...
// Récupère les statistiques en appliquant éventuellement des filtres.
